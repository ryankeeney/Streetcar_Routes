    ...
    var clazz = declare([BaseWidget], {
      ...
      createTimeSlider: function() {
        return this.getTimeSliderProps(this.map).then(lang.hitch(this, function(props) {
		  ...
		  //Ryan Keeney edit line 727: change (props.thumbCount) to (1). This changes the number of thumbs to one.
		  ...
		  //Ryan Keeney edit lines 746-749. All new code. Places thumb at the first index and enables time instant as opposed to default time interval.
		  else{
      ...
      updateTimeExtentLabel: function(timeExtent) {
		...
		//Ryan Keeney edit line 1007. Original code ends with "=label;". Modified code changes date label format above the slider from Month, Day, Year to just Year. 
